...
params_M_11 = list(A=A_M,r=r_M)
assemblages_M_11 = fill_in_assemblages(params = params_M_11, assemblages = generate_assemblages(n = length(r_M)))
write.csv(assemblages_M_11,file='assemblages_M_11.csv',row.names=FALSE)
